...
export function ContactIcons({ email, linkedin, github }: ContactIconsProps) {
	return (
		<div className="contact-icons-container">
			<a href={github} target="_blank">
				<svg className="contact-icon" viewBox="0 0 16 16" fill="currentColor">
			...
			<a href={`mailto:${email}`} target="_blank">
				<svg className="contact-icon" fill="currentColor" viewBox="0 0 32 32">
					<g>
						<g>
